...
- [x] `[all]` Errors follow the Structured Error Shape: `code`, `message`, `hint`, `cause?`, `retryable?` (2026-02-27 — categorized errors: [Network], [Server], [API], [IO] with troubleshooting hints)
